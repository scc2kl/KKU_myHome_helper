...
//            }
        ...
        // 네비게이션 해더를 제거하고 따로 인플레이트 시킨다.
        // 아래 버튼이벤트를 처리한다!!
        View headerView = navigationView.inflateHeaderView(R.layout.nav_header_main);
        Button Login = (Button) headerView.findViewById(R.id.nav_header_login_id_button);
        Login.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = FmActivity.newIntent(MainActivity.this, SingleTon.FM_LOGIN);
...
//        }
        if (id == R.id.nav_manage) {
            Intent intent = FmActivity.newIntent(this, SingleTon.FM_MYPAGE);
            startActivity(intent);
        }
